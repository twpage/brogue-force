...
#define BROGUE_MOD_DESCRIPTION "Archive Scores Mod v0.1 based on Brogue 1.7.4"
...
typedef struct rogueHighScoresEntry {
	...
	// twp extra entry info for record keeping
	int was_victory;
	int level_killed;
	char killed_by[100]; // what killed you or escape/master victory
	int had_amulet;
	short num_gems; // # of lumenstones
